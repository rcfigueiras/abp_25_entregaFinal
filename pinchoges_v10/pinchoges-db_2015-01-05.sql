...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 04, 2015 at 06:54 PM
...
(3, 1, 'profesional', 'profesional', '', 0),
(4, 1, 'profesional2', 'profesional2', '', 0);
...
(121, 1, 8, 'pizza', 'frio', 'pizza cuatro estaciones especial', 3, '/pinchoges_v10/src/imagenes/pizza.jpg', 'almuerzo', 0),
(122, 1, 9, 'tosta de jamon', 'frio', 'tosta de jamon con aceite de oliva', 2, '/pinchoges_v10/src/imagenes/tosta.jpg', 'cena', 0),
(123, 1, 10, 'bacalao', 'caliente', 'bacalao al pinpin', 3, '/pinchoges_v10/src/imagenes/pizza.jpg', 'almuerzo/cena', 0),
(124, 1, 12, 'tempura de verduras', 'caliente', 'tempura de verduras de temporada', 1, '/pinchoges_v10/src/imagenes/tempura.jpg', 'almuerzo', 0);
...
('Outono Ourense', 1, '/pinchoges_v10/src/docs/bases.pdf', '/pinchoges_v10/src/imagenes/logo.jpg');
...
--
ALTER TABLE `jurado_profesional`
MODIFY `ID_juradoProfesional` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
