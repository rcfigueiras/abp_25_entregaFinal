...
<body>
	...
	?>
				...
				<?PHP echo $_SESSION['login']; ?></a></div>

				<form action="<?PHP echo raiz;?>controllers/logout_controlador.php" method="get" role="form">			
						<button type="submit" name="accion" value="Logout" class="btn btn btn-primary">
	...
	<?PHP	} else { ?>
				...
				<div id="formLogin">
					<form action="<?PHP echo raiz;?>controllers/login_controlador.php" method="get" role="form">
							...
							<button type="submit" name="accion" class="btn btn btn-primary" value="Loguear">
