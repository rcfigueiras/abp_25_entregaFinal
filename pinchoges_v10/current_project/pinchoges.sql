...
(8, 1, 'plaza', 'plaza', 'avenida de santiago nº 2', '41 24.2028, 2 10.4418', 'Pincho validado'),
(9, 1, 'estacion', 'estacion', 'calle de la estacion nº 22', '41 24.4256, 2 10.1598', 'Pincho validado'),
(10, 1, 'roda', 'roda', 'rua nova nº 5', '41 25.7548, 2 32.3758', 'Pincho validado'),
(12, 1, 'mou', 'mou', 'venito vicetto nº 6', '14 25.7582, 2 10.4521', 'Pincho validado');
...
(121, 1, 8, 'pizza', 'frio', 'pizza cuatro estaciones especial', 3, '/current_project/src/imagenes/pizza.jpg', 'almuerzo', 1),
(122, 1, 9, 'tosta de jamon', 'frio', 'tosta de jamon con aceite de oliva', 2, '/current_project/src/imagenes/tosta.jpg', 'cena', 1),
(123, 1, 10, 'bacalao', 'caliente', 'bacalao al pinpin', 3, '/current_project/src/imagenes/pizza.jpg', 'almuerzo/cena', 1),
(124, 1, 12, 'tempura de verduras', 'caliente', 'tempura de verduras de temporada', 1, '/current_project/src/imagenes/tempura.jpg', 'almuerzo', 1);
...
('Outono Ourense', 1, '/current_project//src/docs/bases.pdf', '/current_project//src/imagenes/logo.jpg');
...
ALTER TABLE `pinchoges`
  ADD CONSTRAINT `pinchoges_ibfk_1` FOREIGN KEY (`ID_administrador`) REFERENCES `administrador` (`ID_administrador`) ON DELETE NO ACTION ON UPDATE NO ACTION;
