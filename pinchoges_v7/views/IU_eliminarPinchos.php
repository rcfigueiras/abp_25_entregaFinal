...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
  ...
  <!-- Cabecera -->
	...
	<div class="alert alert-warning">Seleccione un pincho para continuar con su eliminaci&oacute;n</div>
	      	    	    <button TYPE="submit" name="accion" VALUE="VolverGesPincho" class="btn btn-block">          <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>Volver</button>
	  ...
	  <div class="col-md-2">
	    <button TYPE="submit" NAME="eliminaEste" VALUE="<?PHP echo $valor['nombre_pincho']?>" class="btn btn-primary">
	      <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> Detallada
	    </button>
