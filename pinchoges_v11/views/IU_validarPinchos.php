...
<body>
	...
	?>
	<div class="alert alert-info">Seleccione un pincho para continuar con su validaci&oacute;n</div>
	...
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>Volver
      ...
      <ul class="list-group">	
		...
		<div class="col-md-1"><!-- Ancho del cuerpo de la página -->
  ...
  </div><!-- Fin ancho del cuerpo de la página -->
</body>
