...
(13, 1, 'frade', 'frade', 'plaza del hierro nº 3', '20 25.4587, 2 87.2365', 'Pincho pendiente de ser validado.');
...
(123, 1, 10, 'bacalao', 'caliente', 'bacalao al pinpin', 3, CONCAT (@Raiz, '/src/imagenes/bacalao.jpg'), 'almuerzo/cena', 0),
(124, 1, 12, 'tempura de verduras', 'caliente', 'tempura de verduras de temporada', 1, CONCAT (@Raiz, '/src/imagenes/tempura.jpg'), 'almuerzo', 0),
(125, 1, 13, 'tortilla', 'caliente', 'torilla de la casa', 1, CONCAT (@Raiz, '/src/imagenes/tortilla.jpg'), 'almuerzo', 0);
