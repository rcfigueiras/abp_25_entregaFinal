...
<body>
	...
	<div class="panel-heading">
	  <h2 class="panel-title">
	            ...
	            Informaci&oacute;n completa del pincho que desea eliminar
	  </h2></div>
	<div class="alert alert-warning">Pulse eliminar para completar la acci&oacute;n</div>
	<div>
	<button TYPE="submit" name="accion" VALUE="VolverListaEliminar" class="btn btn-block">         
	...
	?>					
	<div class="btn-group">
		<button TYPE="submit" name="accion" VALUE="eliminaPincho" class="btn btn-primary">Eliminar</button>
	</div>
